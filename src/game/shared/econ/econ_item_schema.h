...
public:
	...
	bool		IsAlwaysInInventory(void) const		{ return m_bAlwaysInInventory; }
...
public:
	...
	typedef CUtlMap<int, CEconItemDefinition*, int>	AlwaysInInventoryDefinitionMap_t;
	const AlwaysInInventoryDefinitionMap_t& GetAlwaysInInventoryDefinitionMap() const { return m_mapAlwaysInInventory; }
...
private:
	...
	//list of items always in inventory
	AlwaysInInventoryDefinitionMap_t					m_mapAlwaysInInventory;
